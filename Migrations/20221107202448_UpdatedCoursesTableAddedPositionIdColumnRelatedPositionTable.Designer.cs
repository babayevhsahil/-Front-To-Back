...
namespace BaxkendEterna.Migrations
{
    ...
    [Migration("20221107202448_UpdatedCoursesTableAddedPositionIdColumnRelatedPositionTable")]
    partial class UpdatedCoursesTableAddedPositionIdColumnRelatedPositionTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaxkendEterna.Models.Pricing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BaxkendEterna.Models.PricingServices", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BaxkendEterna.Models.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BaxkendEterna.Models.Course", b =>
                {
                    ...
                    b.HasOne("BaxkendEterna.Models.Trainer", "Trainer")
                        .WithMany()
            ...
            modelBuilder.Entity("BaxkendEterna.Models.PricingServices", b =>
                {
                    b.HasOne("BaxkendEterna.Models.Pricing", "Pricing")
                        .WithMany()
                        .HasForeignKey("PricingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BaxkendEterna.Models.Service", "Service")
                        .WithMany()
